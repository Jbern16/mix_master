...
RSpec.describe ArtistsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested artist as @artist and renders then show template" do
      artist = create(:artist)
  ...
  describe "GET #edit" do
    it "assigns the edit artist as @artist" do
      artist = create(:artist)
  ...
  context "with invalid params" do
    it "assigns a newly created but unsaved artist @artist" do
